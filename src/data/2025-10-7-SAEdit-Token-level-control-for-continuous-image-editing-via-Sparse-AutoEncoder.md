...
title: "[논문리뷰] SAEdit: Token-level control for continuous image editing via Sparse
  AutoEncoder"
excerpt: "Or Patashnik이 arXiv에 게시한 'SAEdit: Token-level control for continuous image editing via Sparse
...
permalink: /ai/review/2025-10-7-SAEdit-Token-level-control-for-continuous-image-editing-via-Sparse-AutoEncoder/
