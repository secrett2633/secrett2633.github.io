...
모든 주요 릴리스의 최종 릴리스(예: Python 2.2 final)는 특별한 요구 사항을 가집니다. 특히, 가장 오래 유지될 릴리스 중 하나이기 때문입니다 (베타는 몇 주 이상 지속되지 않지만, 최종 릴리스는 몇 년 동안 지속될 수 있습니다!).
